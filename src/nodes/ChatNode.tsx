...
export default function ChatNodeComponent({
  ...
  return (
    <div className={`flex items-center gap-3 bg-card border-2 rounded-lg px-4 py-3 min-w-[200px] shadow-[0_2px_8px_rgba(0,0,0,0.4)] transition-all duration-200 text-text-main relative ${selected ? "border-[#34d399] shadow-[0_0_0_2px_rgba(52,211,153,0.2)]" : "border-border-card"}`}>
